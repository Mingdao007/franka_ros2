...
#
# The franka.ns-launch.py launch file provides a robust and flexible interface
...
# Example:
# ros2 launch franka_bringup franka.ns-launch.py arm_id:=fr3 namespace:=NS1 robot_ip:=172.16.0.3
...
# franka.ns-launch.py enhances flexibility and scalability for diverse Franka Robotics
# applications.
############################################################################
